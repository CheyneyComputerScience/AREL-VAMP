               ...
               for ((i = 1 ; i <= ${last}; i++)); do
                   ...
                   if [[ "$col1" != "START" && "$col1" != "END" ]] ; then
                       ...
                       if [[ -f ${Y}${col1}-color.h265 && ! -f movies/${col1}/${col1}-${col3}-color.mp4 ]] ; then
                           ffmpeg -framerate 15 -i ${Y}${col1}-color.h265 -c copy movies/${col1}/${col1}-${col3}-color.mp4
                       fi
                       if [[ -f ${Y}${col1}-mono1.h264 && ! -f movies/${col1}/${col1}-${col3}-mono1.mp4 ]] ; then
                           ffmpeg -framerate 15 -i ${Y}${col1}-mono1.h264 -c copy movies/${col1}/${col1}-${col3}-mono1.mp4
                       fi
                       if [[ -f ${Y}${col1}-mono2.h264 && ! -f movies/${col1}/${col1}-${col3}-mono2.mp4 ]] ; then
                           ffmpeg -framerate 15 -i ${Y}${col1}-mono2.h264 -c copy movies/${col1}/${col1}-${col3}-mono2.mp4
                       fi
                       if [[ "$col1" != "opening" && "$col1" != "closing"  && "$col1" != "open" ]] ; then
                           ...
                           if [[ -f movies/${col1}/${col1}-${col3}-color.mp4 && ! -f largeStills/${col1}/${col1}-${col3}-color.png ]] ; then
                               ffmpeg -ss 7.0 -i movies/${col1}/${col1}-${col3}-color.mp4 -r 1 -t 1 largeStills/${col1}/${col1}-${col3}-color.png
                           fi
                           if [[ -f movies/${col1}/${col1}-${col3}-mono1.mp4 && ! -f largeStills/${col1}/${col1}-${col3}-mono1.png ]] ; then
                               ffmpeg -ss 7.0 -i movies/${col1}/${col1}-${col3}-mono1.mp4 -r 1 -t 1 largeStills/${col1}/${col1}-${col3}-mono1.png
                           fi
                           if [[ -f movies/${col1}/${col1}-${col3}-mono2.mp4 && ! -f largeStills/${col1}/${col1}-${col3}-mono2.png ]] ; then
                               ffmpeg -ss 7.0 -i movies/${col1}/${col1}-${col3}-mono2.mp4 -r 1 -t 1 largeStills/${col1}/${col1}-${col3}-mono2.png
                           fi
                       fi
                   fi
               done
