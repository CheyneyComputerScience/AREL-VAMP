...
class Driver(object):
    ...
    commands = {
        ...
        'goto10': b'\x57\x0F\x45\x01\x05\xFF\x0A',
        'goto20': b'\x57\x0F\x45\x01\x05\xFF\x14',
        'goto30': b'\x57\x0F\x45\x01\x05\xFF\x1E',
        'goto40': b'\x57\x0F\x45\x01\x05\xFF\x28',
        'goto50': b'\x57\x0F\x45\x01\x05\xFF\x32',
        'goto60': b'\x57\x0F\x45\x01\x05\xFF\x3C',
        'goto70': b'\x57\x0F\x45\x01\x05\xFF\x46',
        'goto80': b'\x57\x0F\x45\x01\x05\xFF\x50',
        'goto90': b'\x57\x0F\x45\x01\x05\xFF\x5A',
        'tank1': b'\x57\x0F\x45\x01\x05\xFF\x62',
        'tank2': b'\x57\x0F\x45\x01\x05\xFF\x56',
        'tank3': b'\x57\x0F\x45\x01\x05\xFF\x4A',
        'tank4': b'\x57\x0F\x45\x01\x05\xFF\x3B',
        'tank5': b'\x57\x0F\x45\x01\x05\xFF\x32',
        'tank6': b'\x57\x0F\x45\x01\x05\xFF\x26',
        'tank7': b'\x57\x0F\x45\x01\x05\xFF\x1A',
        'tank8': b'\x57\x0F\x45\x01\x05\xFF\x0F',
        'tank9': b'\x57\x0F\x45\x01\x05\xFF\x02',
        'tank10': b'\x57\x0F\x45\x01\x05\xFF\x02',
        'tank11': b'\x57\x0F\x45\x01\x05\xFF\x0F',
        'tank12': b'\x57\x0F\x45\x01\x05\xFF\x1B',
        'tank13': b'\x57\x0F\x45\x01\x05\xFF\x28',
        'tank14': b'\x57\x0F\x45\x01\x05\xFF\x34',
        'tank15': b'\x57\x0F\x45\x01\x05\xFF\x40',
        'tank16': b'\x57\x0F\x45\x01\x05\xFF\x4B',
        'tank17': b'\x57\x0F\x45\x01\x05\xFF\x57',
        'tank18': b'\x57\x0F\x45\x01\x05\xFF\x62',
        'close': b'\x57\x0F\x45\x01\x05\xFF\x64',
        'pause': b'\x57\x0F\x45\x01\x00\xFF',
        'testmove1': b'\x57\x0F\x45\x01\x01\xFF',
        'testmove2': b'\x57\x0F\x45\x01\x02\xFF',
        'testmove3': b'\x57\x0F\x45\x01\x03\xFF',
        'testmove4': b'\x57\x0F\x45\x01\x04\xFF',
        'testmove5': b'\x57\x0F\x45\x01\x05\xFF',
    }
...
def main():
    ...
    parser.add_argument('-c', '--command',  dest='command', required=False, default='press',
                        choices=['press', 'on', 'off', 'open', 'goto10', 'goto20', 'goto30', 'goto40', 'goto50', 'goto60', 'goto70', 'goto80', 'goto90',  'tank1', 'tank2', 'tank3', 'tank4', 'tank5', 'tank6', 'tank7', 'tank8', 'tank9', 'tank10', 'tank11', 'tank12', 'tank13', 'tank14', 'tank15', 'tank16', 'tank17', 'tank18', 'close', 'pause', 'testmove1', 'testmove2', 'testmove3', 'testmove4', 'testmove5'], 
