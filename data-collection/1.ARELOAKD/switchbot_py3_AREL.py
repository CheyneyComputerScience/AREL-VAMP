...
class Driver(object):
    ...
    commands = {
        ...
        'tank10': b'\x57\x0F\x45\x01\x05\xFF\x0A',
        'tank11': b'\x57\x0F\x45\x01\x05\xFF\x14',
        'tank12': b'\x57\x0F\x45\x01\x05\xFF\x1E',
        'tank13': b'\x57\x0F\x45\x01\x05\xFF\x28',
        'tank14': b'\x57\x0F\x45\x01\x05\xFF\x32',
        'tank15': b'\x57\x0F\x45\x01\x05\xFF\x3C',
        'tank16': b'\x57\x0F\x45\x01\x05\xFF\x46',
        'tank17': b'\x57\x0F\x45\x01\x05\xFF\x50',
        'tank18': b'\x57\x0F\x45\x01\x05\xFF\x5A',
...
def main():
    ...
    parser.add_argument('-c', '--command',  dest='command', required=False, default='press',
                        choices=['press', 'on', 'off', 'open', 'goto10', 'goto20', 'goto30', 'goto40', 'goto50', 'goto60', 'goto70', 'goto80', 'goto90',  'tank1', 'tank2', 'tank3', 'tank4', 'tank5', 'tank6', 'tank7', 'tank8', 'tank9', 'tank10', 'tank11', 'tank12', 'tank13', 'tank14', 'tank15', 'tank16', 'tank17', 'tank18', 'close', 'pause'], 
